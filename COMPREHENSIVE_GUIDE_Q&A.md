...
volumes:
  wordpress:
    ...
    driver_opts:
      type: none
      o: bind
      device: /home/mthamir/data/wordpress
  ...
  mariadb:
    ...
    driver_opts:
      type: none
      o: bind
      device: /home/mthamir/data/mariadb
```
...
**Your Project:**
- MariaDB data → `/home/mthamir/data/mariadb`
- WordPress files → `/home/mthamir/data/wordpress`
...
RUN openssl req -x509 -nodes -days 180 -newkey rsa:2048 \
    ...
    -subj "/C=MA/ST=Khnifra-beniMellal/L=Khouribga/O=1337/OU=IT/CN=mthamir.42.fr"
...
http {
    ...
    server {
        ...
        server_name mthamir.42.fr;   # Domain name
